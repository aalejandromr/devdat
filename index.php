...
<body>
    ...
    <!-- <nav id="main_nav">
        <ul>
            ...
            <p>
                <a href="#body" id="access_top" class="access_aid">Skip to top</a>
            </p>
        </ul>
    </nav> -->
    <div class="row main-background"></div>
    ...
    <div class="container mx-auto center">
        <div class="row main-header">
            <div class="s12">
                <h1 class="lg:text-6xl sm:text-6xl text-4xl">We're innovation</h1>
            </div>
            <div class="s12">
                <h3 class="lg:text-2xl sm:text-base text-base">Let us help you grow your business.</h3>
            </div>
        </div>
        ...
        <!-- <div class="services flex items-center">
                <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 web-design">
                ...
                <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 web-applications flex flex-col items-center">
        ...
        <div class="flex flex-wrap items-center justify-center services-wrapper">
            <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 flex flex-col items-center max-w-sm rounded overflow-hidden shadow-lg">
                <img class="services-img" src="./assets/icons/WEB_DESIGN_PNG.png" alt="Web Design" />
                <div class="px-6 py-4">
            ...
            <div class="sm:w-full md:w-full lg:w-1/2 xl:w-1/2 max-w-sm flex flex-col items-center rounded overflow-hidden shadow-lg">
        ...
        <div class="row get-to-know-us content-spacing ">
            ...
            <div class="flex flex-wrap items-center justify-center team-photo-wrapper">
                <div
                    ...
                    <div class="px-6 py-4">
                        <span
                            class="card-text-base inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold  mr-2">#2+ years of experience</span>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="px-6 py-4">
                        <span
                            class="card-text-base inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold  mr-2">#6+ years of experience</span>
                    </div>
                </div>
    ...
    <footer>
        <div class="row contact">
            <div class="header intern-spacing">
                <h2 class="text-3xl">LETS HELP YOUR BUSINESS!</h2>
            </div>
            <hr />
            <div class="text intern-spacing">
                <p class="text-base">
                    Tell us about your project, and get a free quote with an dedicated
                    team.
                </p>
            </div>
            <div class="form">
        ...
        <div class="copy-right ">
            <p class="text-xs">
                DEVDAT 2019 All right reserved | + 1 (239) 628- 6079 |
                <a href=""> info@devdat.io </a>
            </p>
        </div>
    </footer>
</body>

    ...
    <footer>
        <div class="row contact">
            ...
            <div class="text intern-spacing">
                <p> Tell us about your project, and get a free quote with an dedicated team. </p>
            </div>
            <div class="form">
                <form action="">
        ...
        <div class="copy-right">
            <p> DEVDAT 2019 All right reserved | + 1 (239) 628- 6079 | <a href=""> info@devdat.io </a> </p>
        </div>
    </footer>
</body>
<script>
